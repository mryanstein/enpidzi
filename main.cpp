...
int main() {
    ...
    // Konstruktor powinien teraz przyjmować 4 argumenty: imie, ocena, wiek, język
    Student* infStudent = new StudentInformatyki("Tomasz", 5, 25, "C++");
